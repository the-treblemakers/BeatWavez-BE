...
io.on("connection", (socket) => {
    ...
    socket.on("MESSAGE", ({ message, roomName, stageName, timeStamp }) => {
        console.log(message, "MESSAGE");
        roomDirectory[roomName].messageArray = [...roomDirectory[roomName].messageArray, { message, stageName, timeStamp }];
        io.in(roomName).emit("UPDATE_MESSAGE_ARRAY", { message, stageName, timeStamp });
    });
});
